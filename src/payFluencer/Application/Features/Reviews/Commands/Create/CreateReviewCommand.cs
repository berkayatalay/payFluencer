...
public class CreateReviewCommand : IRequest<CreatedReviewResponse>, ISecuredRequest, ICacheRemoverRequest, ILoggableRequest, ITransactionalRequest
{
    public required double Rating { get; set; }
    public required string Comment { get; set; }
    public required Guid GigId { get; set; }

    public string[] Roles => [Admin, Write, ReviewsOperationClaims.Create];
