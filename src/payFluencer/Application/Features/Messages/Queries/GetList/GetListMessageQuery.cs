...
public class GetListMessageQuery : IRequest<GetListResponse<GetListMessageListItemDto>>, ISecuredRequest, ICachableRequest
{
    ...
    public string? CacheKey => $"GetListMessages({PageRequest.PageIndex},{PageRequest.PageSize})";
