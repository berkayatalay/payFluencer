...
public class LoginTests
{
    ...
    {
        _loginCommand.UserLoginDto = new() { Email = "example@kodlama.io", Password = "123456" };
    ...
    {
        _loginCommand.UserLoginDto = new() { Email = "example@kodlama.io", Password = "123456789" };
    ...
    {
        _loginCommand.UserLoginDto = new() { Email = "halit1@kodlama.io", Password = "123456" };
        await Assert.ThrowsAsync<BusinessException>(async () =>
        {
            await _loginCommandHandler.Handle(_loginCommand, CancellationToken.None);
        });
    ...
    {
        _loginCommand.UserLoginDto = new() { Email = "halit1@kodlama.io", Password = "1" };
        TestValidationResult<LoginCommand> validationResult = _validator.TestValidate(_loginCommand);
        validationResult.ShouldHaveValidationErrorFor(i => i.UserLoginDto.Password);
    }

    [Fact]
    public void LoginWithNullPasswordShouldThrowException()
    {
        _loginCommand.UserLoginDto = new() { Email = "halit1@kodlama.io", Password = null! };
        TestValidationResult<LoginCommand> validationResult = _validator.TestValidate(_loginCommand);
        validationResult.ShouldHaveValidationErrorFor(i => i.UserLoginDto.Password);
    }
}
